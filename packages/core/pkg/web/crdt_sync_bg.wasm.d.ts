...
export const wasmstatestore_merge_snapshot: (a: number, b: number, c: number) => [number, number];
export const wasmstatestore_new: (a: number, b: number) => number;
export const wasmstatestore_prune_tombstones: (a: number, b: number) => void;
